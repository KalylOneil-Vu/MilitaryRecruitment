...
export const MOS_OPTIONS: MOSOption[] = [
  ...
  },
  {
    ...
    portraitPrompt: 'Transform this {sex} person into a professional official military portrait of a US Army Soldier. Wearing authentic Army Service Uniform (ASU) dress uniform in dark blue with gold trim, white dress shirt, black tie, prominent rank insignia on chest, unit awards and ribbons. Clean professional appearance. American flag draped in background, formal studio lighting, photorealistic, highly detailed, sharp focus, professional military portrait photography, 8k quality. Maintain facial identity and likeness exactly.',
    fieldPrompt: 'Transform the {sex} person into a professional US Army Signal Support Systems Specialist. Wearing authentic OCP (Operational Camouflage Pattern) uniform with accurate colors (Army Green #4B5320, Coyote Brown #81613C), tactical headset with boom mic, prominent E-5 Sergeant rank insignia on chest. Background: A field command post with high-tech satellite dishes and radio antennas silhouetted against a twilight sky. Lighting: Atmospheric "Magic Hour" lighting mixed with the cool blue glow of radio encryption equipment indicators. Action pose adjusting the frequency on a ruggedized Manpack radio, professional military portrait photography, highly detailed, photorealistic, 8K quality, sharp focus on the radio dials and uniform stitching. Tech-tactical atmosphere. Maintain facial identity and likeness.',
  },
  {
    id: 'aviation',
