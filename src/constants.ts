...
export const MOS_OPTIONS: MOSOption[] = [
  {
    ...
    portraitPrompt: 'Transform this {sex} person into a professional US Army Bradley Fighting Vehicle System Maintainer. Wearing authentic OCP (Operational Camouflage Pattern) uniform with accurate colors (Army Green #4B5320, Coyote Brown #81613C), sleeves rolled up revealing grease-stained forearms, prominent E-5 Sergeant rank insignia (three chevrons) on chest. Background: A gritty military motor pool with the heavy metallic treads and armor plating of a Bradley Fighting Vehicle visible. Lighting: Dramatic side lighting from overhead industrial lamps casting strong shadows. Crouched position inspecting engine components with a diagnostic tool, intense focus on the machinery, professional environmental portrait photography, highly detailed, photorealistic, 8K quality, sharp focus on the mechanical textures and oil grime. Rugged atmosphere. Maintain facial identity and likeness.',
  ...
  },
  {
    ...
    portraitPrompt: 'Transform this {sex} person into a professional US Army Automated Logistical Specialist. Wearing authentic OCP (Operational Camouflage Pattern) uniform with accurate colors (Army Green #4B5320, Coyote Brown #81613C), clean appearance, prominent E-5 Sergeant rank insignia on chest, unit patch on shoulder. Background: A massive, expansive supply warehouse filled with stacked shipping containers and wooden crates, creating a sense of scale and global operations. Lighting: Warm amber lighting from high-bay lamps with shadows between container rows. Action pose coordinating on a tactical radio while directing forklift operations, professional military portrait photography, highly detailed, photorealistic, 8K quality, sharp focus on uniform fabric and warehouse depth. Busy operational atmosphere. Maintain facial identity and likeness.',
  ...
  },
  {
    ...
    portraitPrompt: 'Transform this {sex} person into a professional US Army Information Technology Sergeant (IT Specialist). Wearing authentic OCP (Operational Camouflage Pattern) uniform with accurate colors, prominent E-5 Sergeant rank insignia (three chevrons) on chest patch. Background: A climate-controlled military data center aisle flanked by tall server racks filled with blinking network switches and patch panels. Lighting: Cool blue ambient glow from multiple monitor screens reflecting on face. Seated at a workstation typing on a keyboard, monitoring multiple screens displaying network diagnostics, professional military portrait photography, highly detailed, photorealistic, 8K quality, sharp focus on uniform textures and screen reflections. Focused cyber operations atmosphere. Maintain facial identity and likeness.',
    fieldPrompt: 'Transform the {sex} person into a professional US Army Information Technology Sergeant (IT Specialist). Wearing authentic OCP (Operational Camouflage Pattern) uniform with accurate colors, prominent E-5 Sergeant rank insignia (three chevrons) on chest patch. Background: A climate-controlled military data center aisle flanked by tall server racks filled with blinking network switches and patch panels. Lighting: Cool ambient lighting from overhead fluorescents mixed with the blue and green glow of status LEDs from the server equipment. Action pose holding a bundle of Cat6 ethernet cables and a network cable tester, looking up at a rack, professional military portrait photography, highly detailed, photorealistic, 8K quality, sharp focus on uniform textures and cabling details. Low key lighting. Maintain facial identity and likeness.',
    media: [
  ...
  },
  {
    ...
    portraitPrompt: 'Transform this {sex} person into a professional US Army AH-64 Apache Helicopter Pilot. Wearing authentic Army Aircrew Combat Uniform (A2CU) flight suit in OCP pattern with accurate colors (Army Green #4B5320, Coyote Brown #81613C), prominent Army Aviation Wings badge and E-5 Sergeant rank on chest. Wearing flight helmet with visor up, seated in Apache cockpit with instrument panels and HUD display visible. Background: Cockpit interior view with airfield tarmac visible through canopy glass. Lighting: Natural daylight through canopy mixed with green glow from cockpit instruments. Confident expression ready for mission, professional aviation portrait photography, highly detailed, photorealistic, 8K quality, sharp focus on cockpit controls and flight gear. Pre-flight atmosphere. Maintain facial identity and likeness.',
  ...
  },
  {
    ...
    portraitPrompt: 'Transform this {sex} person into a professional US Army Combat Medic Specialist. Wearing authentic OCP (Operational Camouflage Pattern) uniform with accurate colors (Army Green #4B5320, Coyote Brown #81613C), prominent E-5 Sergeant rank insignia, and distinct "MEDIC" patch on the vest. Background: The interior of a modern field medical tent with advanced medical monitoring equipment and hanging IV bags. Lighting: Warm overhead surgical lights with soft shadows. Focused expression while treating a wounded soldier, hands working with medical supplies, professional medical portrait photography, highly detailed, photorealistic, 8K quality, sharp focus on the medical gear textures and determined expression. Urgent life-saving atmosphere. Maintain facial identity and likeness.',
  ...
  },
  {
    ...
    portraitPrompt: 'Transform this {sex} person into a professional US Army Infantry Squad Leader. Wearing authentic OCP (Operational Camouflage Pattern) uniform with accurate colors (Army Green #4B5320, Coyote Brown #81613C), full tactical kit including IOTV body armor, combat helmet with night vision mount, and prominent E-5 Sergeant rank insignia. Background: A rugged, outdoor training environment with blurred forestry and smoke haze. Lighting: Dramatic golden hour sunlight breaking through trees with atmospheric haze. Action pose using tactical hand signals to direct squad movement, intense focused expression, professional combat photography, highly detailed, photorealistic, 8K quality, sharp focus on tactical gear and camouflage patterns. Leadership in action atmosphere. Maintain facial identity and likeness.',
